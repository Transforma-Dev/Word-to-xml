...
def title(para, xml_text, variables, data, journal, file_name, logger):
    ...
    try:
        ...
        #Success log message
        logger.info(f"Successfully created the title tag in (title.py)-file")
    except Exception as e:
        print(f"Error in (title function) in (title.py)-file {e}")
        #Error log message
        logger.error(f"Error in (title function) in (title.py)-file {e}")
