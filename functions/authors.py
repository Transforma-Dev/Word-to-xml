...
def author_name(xml_text, variables, logger):
    try:
        ...
        #Success log message
        logger.info(f"Successfully created the author name tag in (author_name function) in (authors.py)-file")

        return text
    except Exception as e:
        print(f"Error in (author_name function) in (authors.py)-file {e}")
        #Error log message
        logger.error(f"Error in (author_name function) in (authors.py)-file {e}")
        text = ""
        return text


#Define function to find aff text
def aff_para(xml_text, variables, logger):
    ...
    try:
        ...
        #Success log message
        logger.info(f"Successfully created the aff tag from (aff_para function) (authors.py)-file")
    except Exception as e:
        print(f"Error in (aff_para function) (authors.py)-file {e}")
        #Error log message
        logger.error(f"Error in (aff_para function) (authors.py)-file {e}")

    return text


#Define function to find coresponding author
def corres_author(xml_text, variables, logger):
    ...
    try:
        ...
        #Error log message
        logger.error(f"Error in (corres_author function) (authors.py)-file {e}")