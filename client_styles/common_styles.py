...
def space_add_text(element, data):
...
def space_remove_text(element, data):
...
def space_before_text(element, data):
...
def space_after_text(element, data):
...
def remove_space_before_text(element, data):
...
def change_text(element, refere, function_name, data):
    ...
    for child in element:
        change_text(child, refere, function_name, data)
